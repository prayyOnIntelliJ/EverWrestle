...
- Implemented [Voice Chat (Proximity, Radio)](https://blueprintue.com/blueprint/cd2t1cjd/), allowing players to communicate based on their distance in the game world
- Integrated the [player input system](https://blueprintue.com/blueprint/lnqipw8w/), setting up and configuring all gameplay input actions and bindings
